...
- [Do](#do)
- [Do Not](#do-not)
- [Shared Template Policy](#shared-template-policy)
- [Standard Asset Folder Pattern](#standard-asset-folder-pattern)
- [Concrete Path Examples](#concrete-path-examples)
- [Naming Rules](#naming-rules)
- [Worked Example Flow: Reexport A Prop Mesh](#worked-example-flow-reexport-a-prop-mesh)
- [Git/LFS Notes](#gitlfs-notes)
